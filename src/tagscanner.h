...
public:
  ...
  bool isFunc() const
  {
    return (m_type == TAG_FUNC) ? true : false;
  };
  bool isClassMember() const
  {
    return m_className.isEmpty() ? false : true;
  };
...
private:
  ...
  static int execProgram(QString name, QStringList argList, QByteArray* stdoutContent, QByteArray* stderrContent);
