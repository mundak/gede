...
public:
  ...
  void setVarType(QString varType)
  {
    m_varType = varType;
  };
  QString getVarType()
  ...
  void setPointerAddress(quint64 addr)
  {
    m_addressValid = true;
    m_address = addr;
  };
  bool hasPointerAddress()
  {
...
public:
  ...
  QString getValue(CoreVar::DispFormat fmt = CoreVar::FMT_NATIVE)
  {
    return m_var.getData(fmt);
  };

  void setValue(QString value);
  long long getPointerAddress()
  {
    return m_var.getPointerAddress();
  };
  bool hasPointerAddress()
  {
    return m_var.hasPointerAddress();
  };
