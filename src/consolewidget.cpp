...
void ConsoleWidget::keyPressEvent(QKeyEvent* event)
{
  ...
  {
  case Qt::Key_End:
    core.writeTargetStdin("\033[F");
    break;
  case Qt::Key_Home:
    core.writeTargetStdin("\033[H");
    break;
  case Qt::Key_Left:
    core.writeTargetStdin("\033[D");
    break;
  case Qt::Key_Right:
    core.writeTargetStdin("\033[C");
    break;
  case Qt::Key_Up:
    core.writeTargetStdin("\033[A");
    break;
  case Qt::Key_Down:
    core.writeTargetStdin("\033[B");
    break;
  case Qt::Key_Backspace:
  {
    if (m_cfg)
    {
      ...
      default:
      case 0:
        core.writeTargetStdin("\x7f");
        break;
      case 1:
        core.writeTargetStdin("\x08");
        break;
      case 2:
        core.writeTargetStdin("\033[3~");
        break;
      };
      break;
    }
