...
const char* GdbCom::asyncClassToString(GdbComListener::AsyncClass ac)
{
  switch (ac)
  {
  case GdbComListener::AC_STOPPED:
    return "stopped";
    break;
  case GdbComListener::AC_RUNNING:
    return "running";
    break;
  case GdbComListener::AC_THREAD_CREATED:
    return "thread_created";
    break;
  case GdbComListener::AC_THREAD_GROUP_ADDED:
    return "thread_group_added";
    break;
  case GdbComListener::AC_THREAD_GROUP_STARTED:
    return "thread_group_started";
    break;
  case GdbComListener::AC_LIBRARY_LOADED:
    return "library_loaded";
    break;
  case GdbComListener::AC_BREAKPOINT_MODIFIED:
    return "breakpoint_modified";
    break;
  case GdbComListener::AC_BREAKPOINT_DELETED:
    return "breakpoint_deleted";
    break;
  case GdbComListener::AC_THREAD_EXITED:
    return "thread_exited";
    break;
  case GdbComListener::AC_THREAD_GROUP_EXITED:
    return "thread_group_exited";
    break;
  case GdbComListener::AC_LIBRARY_UNLOADED:
    return "library_unloaded";
    break;
  case GdbComListener::AC_THREAD_SELECTED:
    return "thread_selected";
    break;
  case GdbComListener::AC_DOWNLOAD:
    return "download";
    break;
  case GdbComListener::AC_CMD_PARAM_CHANGED:
    return "cmd_param_changed";
    break;
  case GdbComListener::AC_UNKNOWN:
    return "unknown";
    break;
  };
  return "?";
...
int GdbCom::parseAsyncOutput(Resp* resp, GdbComListener::AsyncClass* ac)
{
  ...
  else if (acString == "tsv-created" || acString == "tsv-deleted" || acString == "tsv-modified")
  {
...
Token* GdbCom::eatToken(Token::Type type)
{
  ...
  {
    errorMsg("Expected '%s' but got '%s'", Token::typeToString(type), tok ? stringToCStr(tok->getString()) : "<NULL>");
    return NULL;
  }
  pop_token();
  return tok;
